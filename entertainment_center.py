...
avengers = media.Movie("The Avengers", "Earth's mightiest heroes defend earth",
                       "http://upload.wikimedia.org/wikipedia/en/f/f9/TheAvengers2012Poster.jpg",
                       "https://www.youtube.com/watch?v=eOrNdBpGMv8",
                       "May 4, 2012 (USA)")

imitation = media.Movie("The Imitation Game",
                        "Alan Turing works to crack the code of the Enigma Machine",
...
transcendence = media.Movie("Transendence",
                            "An AI researcher achieves transcendence by going digital",
...
holy_grail = media.Movie("Monty Python and the Quest for the Holy Grail",
                         "A group of knights seek out the Holy Grail, hilarity ensues",
...
to_the_greek = media.Movie("Get Him to the Greek",
                           "An understudy of Jay-Z has to get a washed up rock star to play a show",
                           "http://upload.wikimedia.org/wikipedia/en/c/c2/Get_Him_to_the_Greek.jpg",
                           "https://www.youtube.com/watch?v=N6ixkr0-qvo",
                           "June 4, 2010 (USA)")

#The array of movies to be loaded
movies = [tucker, avengers, imitation, transcendence, holy_grail, to_the_greek]
